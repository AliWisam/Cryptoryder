...
//     && users[msg.sender].ratings == 0x0 && users[msg.sender].driverRating == 0x0)
//     {
...
//     uint8 numberOfRidesTaken) public payable onlyExistingUser returns(uint8,uint8,uint8,uint8,uint8){
